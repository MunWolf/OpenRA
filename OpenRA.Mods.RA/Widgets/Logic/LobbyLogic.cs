...
namespace OpenRA.Mods.RA.Widgets.Logic
{
	public class LobbyLogic
	{
			...
			Action onExit, Action onStart, bool skirmishMode)
		{
			...
			if (techLevel != null)
			{
				var techTraits = Rules.Info["player"].Traits.WithInterface<ProvidesTechPrerequisiteInfo>();
				techLevel.IsVisible = () => orderManager.LobbyInfo.GlobalSettings.TechLevel != "-1";
				optionsBin.GetOrNull<LabelWidget>("TECHLEVEL_DESC").IsVisible = () => orderManager.LobbyInfo.GlobalSettings.TechLevel != "-1";
				techLevel.IsDisabled = () => Map.Status != MapStatus.Available || Map.Map.Options.TechLevel != null || configurationDisabled() || techTraits.ToArray().Length == 1;
